# Scrapes Uttar Pradesh 2017 Vidhan Sabha results
...
starturl = 'http://www.eciresults.nic.in/ConstituencywiseS24'

#Your info goes here:
headers = {'user-agent': 'Intel_Mac_OSX 10_12_3; your_name/location/e-mail'}

#Get constituency list and numbers
res = requests.get('http://www.eciresults.nic.in/ConstituencywiseS2487.htm?ac=87', headers=headers)
...
cons = soup.find_all('input',{"id":"HdnUP"}) #UP constituency list
...
def extract_constituency(consid):
    ...
    try:
        ...
        for tr in table_rows:
            ...
            row.append('Uttar Pradesh')
            row.append('24') # ECI state ID number
